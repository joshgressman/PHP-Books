...
$mail = new PHPMailer; // checks that email is valid
  ...
  <div class="wrapper">
    ...
    <form method="post" action="suggest.php">
      <table>
        ...
        <tr>
          <th><label for="categoty">Category (required)</label></th>
          <td><select id="category" name="category">
              ...
              <option value="Music">Music <?php if(isset($category) && $category == "Music"){echo " selected";} ?></option>
          </select></td>
        </tr>
        <tr>
